...
export default function RegisterPage() {
  return (
    <div
      className={`${fraunces.variable} ${manrope.variable} h-screen flex flex-col overflow-hidden bg-[#F4F5FC]`}
      style={{
      ...
      <div className="flex-1 flex min-h-[calc(100vh-80px)]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10">
          <div className="w-full max-w-xl h-full flex flex-col justify-center">
            ...
            {/* The Pass */}
            <div className="relative rounded-[28px] bg-black border border-white/10 shadow-[0_25px_60px_-20px_rgba(0,0,0,0.65)] p-5 sm:p-6 overflow-hidden flex flex-col max-h-[88vh]">
              <div
              ...
              <div className="relative mt-3 text-center text-[10px] font-medium text-slate-500 shrink-0">
                🔒 Secure, encrypted connection &bull; © 2026 ZEYO
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:flex w-1/2 relative">
          ...
          <div
            ...
            style={{ background: "linear-gradient(135deg, #F59E0B, #FB923C)", opacity: 0.2 }}
          />
