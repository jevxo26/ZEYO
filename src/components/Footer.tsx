...
export function Footer() {
    ...
    return (
        <footer className="w-full relative z-10 border-t border-slate-200/50 dark:border-slate-800/50 bg-white/40 dark:bg-slate-950/40 backdrop-blur-md overflow-hidden">
            ...
            <div className="absolute top-0 left-1/4 w-[500px] h-[300px] bg-amber-200/10 dark:bg-amber-500/5 rounded-full blur-3xl pointer-events-none -translate-y-1/2"></div>
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[300px] bg-orange-200/10 dark:bg-orange-500/5 rounded-full blur-3xl pointer-events-none translate-y-1/2"></div>
          ...
          <span className="flex items-baseline gap-2">
            <span className="text-[15px] font-bold tracking-widest text-slate-900 dark:text-white">
              ZEYO
            </span>
              ...
              — Every moment, perfectly planned
                            ...
                            {[
                                ...
                                <li key={idx}>
                                    <Link 
                                        ...
                                        className="text-sm text-slate-600 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 transition-all duration-200 inline-flex items-center group/link hover:translate-x-1"
                                    >
                                        <ArrowRight size={12} className="opacity-0 w-0 group-hover/link:opacity-100 group-hover/link:w-3 group-hover/link:mr-1 transition-all duration-200 text-amber-500" />
                                        {service}
                                    </Link>
                                </li>
                            ))}
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start space-x-3 text-sm text-slate-600 dark:text-slate-400">
                                    <MapPin size={16} className="text-amber-500 dark:text-amber-400 shrink-0 mt-0.5" />
                                ...
                                <li className="flex items-center space-x-3 text-sm text-slate-600 dark:text-slate-400">
                                    <Phone size={16} className="text-amber-500 dark:text-amber-400 shrink-0" />
                                    <a href="tel:+8801700000000" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                                        +880 1700 000 000
                                    </a>
                                </li>
                                <li className="flex items-center space-x-3 text-sm text-slate-600 dark:text-slate-400">
                                    <Mail size={16} className="text-amber-500 dark:text-amber-400 shrink-0" />
                                    <a href="mailto:hello@zeyo.com" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                                        hello@zeyo.com
                                    </a>
                                </li>
                            </ul>
                            ...
                            {isSubscribed ? (
                                ...
                                <form onSubmit={handleSubscribe} className="flex gap-2 w-full max-w-sm">
                                    <Input
                                        ...
                                        className="h-9 px-3 bg-white/50 dark:bg-slate-900/50 border-slate-200 dark:border-slate-800 focus-visible:ring-amber-500/30 rounded-xl"
                                    />
                                    <Button
                                        type="submit"
                                        size="sm"
                                        disabled={isLoading}
                                        className="h-9 px-4 bg-black hover:bg-slate-800 text-amber-400 rounded-xl shadow-md hover:shadow-black/25 transition-all flex items-center justify-center disabled:opacity-75"
                                    >
                                        {isLoading ? (
                ...
                <div className="border-t border-slate-200/50 dark:border-slate-800/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                        &copy; {currentYear} ZEYO  Inc. All rights reserved.
                    </p>
