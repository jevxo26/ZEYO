    ...
    <div className="space-y-4 animate-fadeIn">
      {selectedServices.map((srv, idx) => {
        ...
        return (
          <div
            key={srv.key}
            className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm overflow-hidden transition-all duration-200"
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-5 sm:p-6 text-left hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors"
            >
              <div className="flex items-center gap-4 min-w-0">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold text-sm shrink-0">
                  {idx + 1}
                </div>
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300">
            ...
            {/* Expanded Body */}
            {isOpen && (
              <div className="px-5 pb-6 sm:px-6 sm:pb-8 border-t border-slate-200/60 dark:border-slate-800/60 pt-6 space-y-8">
                {/* 1. Select Tier */}
                <div>
                  <h5 className="text-sm font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-3 flex items-center gap-2">
                    ...
                    {srv.tiers.map((t) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-800/60 flex items-baseline justify-between">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 max-w-sm">
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-bold focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                          ...
                          <button
                            ...
                            className={`px-4 py-2.5 rounded-xl border font-semibold text-sm transition-all ${
                              isSelected
                                ...
                                : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:border-indigo-300 dark:hover:border-indigo-700"
                            }`}
                          >
                            {c.name}
                          </button>
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center justify-between p-3.5 rounded-xl border text-left transition-all ${
                              isChecked
                                ? "border-emerald-600 bg-emerald-50/90 dark:bg-emerald-950/40 text-emerald-950 dark:text-emerald-200 font-semibold"
                          ...
                          >
                            ...
                            <span className="text-xs font-bold px-2 py-1 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 shrink-0">
